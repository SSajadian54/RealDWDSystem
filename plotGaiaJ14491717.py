...
ra0 = 15.0*(14.0+49.0/60.0+57.15/3600.0) 
dec0=  1.0*(17.0+17.0/60.0+29.33/3600.0) 
...
id2=0
for i in range(nrow): 
    if(df.source_id[i]==1236249956118497152):  
        id1=i
    if(df.source_id[i]==1236250815111959552):  
        id2=i  
...
plt.scatter( (Ra-Ra[id0])*60.0 ,     (Dec-Dec[id0])*60.0 ,     s=Mag, marker="o", facecolors='pink', edgecolors='m')##,  "ro")
plt.scatter( (Ra[id0]-Ra[id0])*60.0, (Dec[id0]-Dec[id0])*60.0, s=Mag[id0]*1.0, marker="*", color="g")##,  "ro")
plt.scatter( (Ra[id1]-Ra[id0])*60.0, (Dec[id1]-Dec[id0])*60.0, s=Mag[id1]*1.0, marker="^", color="b")##,  "ro")
plt.xticks(fontsize=18, rotation=0)
plt.yticks(fontsize=18, rotation=0)
plt.xlabel(r"$\rm{RA(arcm)}-222.5^{\circ}$", fontsize=18.0)
plt.ylabel(r"$\rm{Dec(arcm)}-17.3^{\circ}$", fontsize=18.0)
#plt.text(18.4,7.11,r"$-28^{\circ}$", fontsize=18.0)
plt.text(-0.2,-0.15, r"$\rm{J1449}+1717$",fontsize=18.0)
plt.text(-0.6,-1.1,r"$\rm{Variable}~\rm{star}$",fontsize=18.0)
plt.xlim([-1.5, 1.0])
plt.ylim([-1.5, 1.0])
plt.grid("True")
...
fig=plt.gcf()
fig.tight_layout()
fig.savefig("gaiaJ14491717.jpg",dpi=200)
##########################################################
...
plt.grid(linestyle='dashed')
fig=plt.gcf()
fig.savefig("colmag_433.jpg",dpi=200)
